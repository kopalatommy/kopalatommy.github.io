...
const exp = [
  {
    ...
    cardImage: "images/experience-page/2b.png",
    place: "2B Technologies",
    time: "(June, 2019 - present)",
    desp: "<li>Wrote connected firmware and software systems.</li> <li>Created user friendly UI.</li> <li>Maintained graphical software.</li>",
  },
  /*{
